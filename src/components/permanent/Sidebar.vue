                ...
                a {
                    ...
                    &:hover {
                        ...
                        div {
                            ...
                            padding-right: 75px;
                            width: auto;
                            transition-property: width, padding-right, opacity;
                            transition-duration: 1s;
