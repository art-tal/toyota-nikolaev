                ...
                <div class="col-lg-6 col-12 info">
                    ...
                    <article class="row">
                        ...
                        <div class="col-11">
                            ...
                            <p>{{getServiceCar.date}}, {{getServiceCar.time}}</p>
                        </div>
                    </article>
                    <hr>
                    <article class="row">
...
<script>
    export default {
        ...
        computed: {
            getServiceCar() {
                return this.$store.getters.getServiceCar;
            },
        },
        ...
        methods: {
            clearForm() {
                // setTimeout( () => {
                localStorage.requestToService = "";
                // localStorage.testDrive= "";
