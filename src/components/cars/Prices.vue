...
<!--        <div class="container-fluid"  :style="{'background-color': computedColor.rgb, 'color': fontColored + '!important'}">-->
        ...
        <div class="specifications row justify-content-center align-items-end">
            <div class="price col-xl-2 col-md-3 col-sm-6 col-12 text-md-left text-center" v-if="computedEquipment.gross_price">
                <p>Від</p>
            ...
            <div class="fuelConsumption col-xl-2 col-md-3 col-sm-6 col-12" v-if="computedEquipment.fuel">
            ...
            <div class="seats col-xl-2 col-md-3 col-sm-6 col-12" v-if="model.seats">
                <p>Кількість місць</p>
