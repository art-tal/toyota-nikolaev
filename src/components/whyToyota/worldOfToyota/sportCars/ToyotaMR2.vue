<template>
    <section>
        ...
        <div class="body container">
            <h4>Модель MR2 зразка 1984 року фактично являла собою подальший розвиток розробленого у 1976 році проекту, метою якого було створення динамічного і водночас економічного автомобіля, багато в чому подібного до Sports 800. З часом ідея оригінальної концепції еволюціонувала у спорткар, що призвело до народження «середньомоторного, невеликого 2-місного» авто (Midship Runabout 2-seater), яке приєдналося до більших за розміром родичів – моделей Celica та Supra.</h4>
            <div class="block_right">
                <h5>Компактне джерело задоволення для нового покоління</h5>
                <p>Компактний і практичний кузов, видатна маневреність, динаміка та чутливий двигун MR2 стали запорукою фантастичного задоволення від керування. Ще одна оригінальна опція – дах T-bar, що додатково посилював відчуття свободи. Модель MR2 стала першим серійним японським авто з центральним розташуванням двигуна. Така компоновка отримала одноголосне схвалення з боку преси, завдяки чому ця маленька Toyota отримала престижний титул «Японський автомобіль року 1984-1985».</p>
            ...
            <div class="block_right">
                ...
                <p>Хоча третє і останнє покоління зберегло таку саму назву (у Японії автомобіль продавався як MR-S), це була зовсім нерівнозначна заміна. Замість більшого за розміром і «дорослішого» попередника на ринок вийшов менший, легший і дешевший родстер з відкритим верхом. Новий MR2 Roadster отримав все необхідне для того, щоб стати бездоганним динамічним спорткаром наступного століття.</p>
                <p>Як і Celica, модель MR2 стала жертвою глобального спаду на ринку спорткарів й у 2007 році виробництво моделі було нарешті припинено. За два десятиліття, протягом яких світ побачили три покоління моделі, MR2 зробила вагомий внесок у життях багатьох людей і надовго залишиться у пам’яті.</p>
        ...
        <div class="next_part container-fluid">
            ...
            <router-link
                    tag="header"
                    exact
                    to="/world_of_toyota/toyota_gt86"
            >
                <h2>
                    GT86<br>
