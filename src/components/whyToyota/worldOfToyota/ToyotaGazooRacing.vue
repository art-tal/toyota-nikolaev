    ...
    <section class="container-fluid">
        <header>
            <h1 class="text-center">Драйвове пересування будь-якими дорогами
                ...
                <img :src="require('../../../img/' + dirImg + '/WorldOfToyota/TGR-HeaderLogo_tcm-3046-781341.png')" alt="TOYOTA GAZOO Racing logo">
            </h1>
        </header>
...
<!--            ></div>-->
        ...
        <div class="body container right_side">
            ...
            <img :src="require('../../../img/' + dirImg + '/WorldOfToyota/3-TGR-New-name_tcm-3046-778412.jpg')" alt="/">
...
<!--            ></div>-->
        ...
        <div class="body container right_side">
            ...
            <img :src="require('../../../img/' + dirImg + '/WorldOfToyota/toyota-ts050-gazoo-racing_tcm-3046-778418.jpg')" alt="photo">
            ...
            <img :src="require('../../../img/' + dirImg + '/WorldOfToyota/6-TGR-WEC-mosaic_tcm-3046-778421.jpg')" alt="photo">
...
<!--            <img src="//t1-cms-3.images.toyota-europe.com/toyotaone/uaua/toyota-yaris-gazoo-racing_tcm-3046-778440.jpg" alt="photo">-->
            <img :src="require('../../../img/' + dirImg + '/WorldOfToyota/toyota-yaris-gazoo-racing_tcm-3046-778440.jpg')" alt="photo">
...
<!--            <img src="//t1-cms-4.images.toyota-europe.com/toyotaone/uaua/10-NUR-Toyota-C-HR_tcm-3046-778447.jpg" alt="photo">-->
            <img :src="require('../../../img/' + dirImg + '/WorldOfToyota/10-NUR-Toyota-C-HR_tcm-3046-778447.jpg')" alt="photo">
...
<!--            <img src="//t1-cms-1.images.toyota-europe.com/toyotaone/uaua/11-NUR-Mosaic_tcm-3046-778448.jpg" alt="photo">-->
            <img :src="require('../../../img/' + dirImg + '/WorldOfToyota/11-NUR-Mosaic_tcm-3046-778448.jpg')" alt="photo">
